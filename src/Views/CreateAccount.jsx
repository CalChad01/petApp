...
function CreateAccount() {
  ...
  return (
    <div className="min-h-screen flex items-start py-10 space-x-10">
      ...
      // Select Account Type
      <div className="grid gap-2 place-items-center w-fit justify-self-center text-blue-900 text-opacity-75  p-3 shadow-2xl bg-white">
        <h1 className="text-center font-bold text-4xl select-none">
          What are you looking for?
        </h1>
        <button value="owner" onClick={(e) => handleSelectAcct(e)} className="bg-blue-600 text-white font-bold p-3 w-3/5 rounded-lg hover:duration-100 hover:scale-105 hover:bg-blue-400">"I'm a  looking to adopt a pet!"</button>
        <button value="shelter" onClick={(e) => handleSelectAcct(e)} className="bg-blue-500 text-white font-bold p-3 w-3/5 rounded-lg hover:duration-100 hover:scale-105 hover:bg-blue-400">"I'm a pet shelter."</button>
      </div>
      }
    </div>
